...
public class SouthIsraelRestaurantPage extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.israel_south_resturant_page);
        Log.d("SouthIsraelRestaurantPage", "onCreate: Activity started");
        ...
        if (intent != null) {
            ...
            Log.d("SouthIsraelRestaurantPage", "Received Latitude: " + userLatitude + ", Longitude: " + userLongitude);
        } else {
            Log.e("SouthIsraelRestaurantPage", "Intent is NULL!");
        }
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("SouthIsraelRestaurantPage", "Back button clicked");
                finish();
            }
        });
